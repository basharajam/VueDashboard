    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-11">
                ...
                <div class="row" id='sortableProdByTag'>
        ...
        <div class="row">
            <div class="col-sm-11">
                ...
                <div class="row" id='sortableProdByTagMobile'>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name=compwhereNI]').val('ProdByTag');
        })

        //ProdByCat  page Dragable Desktop
        const sortable = new Draggable.Sortable(
        document.querySelector('#sortableProdByTag'), {
          draggable: 'div.card',
        })
        sortable.on('sortable:stop', () => {
            ...
            var i=1
            setTimeout(() => {
              $('#sortableProdByTag div.card').each(function(){
        ...
        document.querySelector('#sortableProdByTagMobile'), {
          draggable: 'div.card',
        })
        sortableMobile.on('sortable:stop', () => {
            ...
            var i=1
            setTimeout(() => {
              $('#sortableProdByTagMobile div.card').each(function(){
