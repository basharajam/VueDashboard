    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-11">
                ...
                <div class="row" id='sortableAllCat'>
        ...
        <div class="row">
            <div class="col-sm-11">
                ...
                <div class="row" id='sortableAllCatMobile'>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name=compwhereNI]').val('AllCat');
        })

        //AllCat  page Dragable Desktop
        const sortable = new Draggable.Sortable(
        document.querySelector('#sortableAllCat'), {
          draggable: 'div.card',
        })
        sortable.on('sortable:stop', () => {
            ...
            var i=1
            setTimeout(() => {
              $('#sortableAllCat div.card').each(function(){
        ...
        //AllCat  page Dragable Mobile
        const sortableMobile = new Draggable.Sortable(
        document.querySelector('#sortableAllCatMobile'), {
          draggable: 'div.card',
        })
        sortableMobile.on('sortable:stop', () => {
            ...
            var i=1
            setTimeout(() => {
              $('#sortableAllCatMobile div.card').each(function(){
